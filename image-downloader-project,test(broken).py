...
# script based on João Tinti's script, https://github.com/joaotinti75/Pokemon_Classification/blob/master/google_imgs_downloader_v2.py
...
def google_images_download(directory, search, num_of_img):
    ...
    url1 = f'https://pixiv.net/en/tags/{search}/artworks'
    i = 0
    ...
    table = soup.find_all('div', attrs={'class': 'sc-15n9ncy-0 fDEFeI'})
    print(table, 'a')
    ...
    if i < num_of_img:
        while True:
            links_list = []
            img_list = []
            urln = f'https://pixiv.net/en/tags/{search}/artworks?p={page}'
